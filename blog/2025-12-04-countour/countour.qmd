...
Calculate contour lines. Since we are using Bathymetry data, and contour lines are often given specific names beginning with "iso-" according to the nature of the variable, the lines being mapped from Bathymetric data can also be refereed as isobaths. 
