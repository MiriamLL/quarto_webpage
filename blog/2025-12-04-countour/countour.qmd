...
title: "Contour lines"
description: |
  In this blog post, we'll explore how to plot contour lines from a raster
author:
  - name: Miriam Lerma
    url: {}
date: 2025-12-04
...
For the example, we will be using Bathymetry data. Bathymetry gives us information on the water depth around an area.
