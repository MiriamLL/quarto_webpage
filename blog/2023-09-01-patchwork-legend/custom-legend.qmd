...
ggsave((GPS01_plot+plot_spacer()+
  ...
  plot_layout(ncol = 2,
              widths = c(5,1), 
              heights=c(1,1)), 
       filename = paste0(here(),"/blog/2023-09-01-patchwork-legend/legend_export.jpg"),
       width = 5, 
       height = 6, 
       units = "in",
       dpi = 300)
...
knitr::include_graphics(paste0(here::here(),"/blog/2023-09-01-patchwork-legend/legend_export.jpg"))
```
...
- Package [patchwork](https://patchwork.data-imaginist.com/)
