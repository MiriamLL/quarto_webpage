...
title: "Contour lines"
description: |
  In this blog post, we'll explore how to make contour lines from a raster (in this case from Bathymetry)
author:
  - name: Miriam Lerma
    url: {}
date: 2025-12-15
image: contour_front.jpeg
format:
  html:
    toc: true
    toc-depth: 2
...
This months blog post is about how to create contour lines from a raster file and how to add labels using the package metR.
...
Bath_9plot<-Bath_8plot+geom_shadowtext(
    ...
    aes(x = X, y = Y, label = -level),  # label is -level
    size = 4,
    color = "black",
...
library(here)
here()
My_directory<-paste0(here(),"/blog/2025-12-15-countour")
ggsave(Bath_9plot,
...
knitr::include_graphics(paste0(here::here(),"/blog/2025-12-15-countour","/contour_export.jpeg"))
```
